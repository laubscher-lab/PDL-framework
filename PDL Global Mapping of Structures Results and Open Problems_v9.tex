...
D22 &
  ...
  First formal derivation of the neutron integer quintuplet $(24,28,1032,9960,10992)$ via $R_{\mathrm{tot}}(n) = R_{\mathrm{tot}}(p) - (\Delta n+1)^2$; nuclear binding as balanced exchange of mixed coherent triangles; maximum magic number $N_{\mathrm{crit,max}} = 126.1$ from sea-exhaustion condition without free parameters; saturation threshold $Z_{\mathrm{sat}} \approx 20$ (calcium); structural origin of nuclear spin-orbit coupling in $\Delta n = 4$; periodic table as map of collective closures bounded by sea exhaustion.\citep{Nuclear_Stability_PDL_2026} &
