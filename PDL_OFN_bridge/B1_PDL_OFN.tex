...
\author{
  C\'edric Laubscher,\ Oleg I.\ Evdokimov, \ Elena Ryss
}
...
\bigskip
\textbf{Epistemic status of \(\Omega_{21}\).}  
The selection of this specific 21-point subset is not derived from first principles within the CWS axioms presented here. It is a \textbf{structural postulate}, anchored in the independent topological analysis by Bachani (2026)~\cite{Bachani2026}. We take \(\Omega_{21}\) as the given vacuum manifold and verify its properties. The justification for this particular selection lies outside the scope of the present numerical verification.
...
\end{center}
The graph has two connected components: a main component of 20 vertices, and one isolated vertex — decimal 21, i.e. (0, 1, 0, 1, 0, 1), which has no Hamming-distance-1 neighbour within $\Omega_{21}$.  
\textbf{Notably}, this vertex is not self-conjugate under the CP-involution $x \mapsto 63 - x$ (its image is 42, binary 101010). In fact, $\Omega_{21}$ contains \textbf{no} self-conjugate states because the equation $x = 63 - x$ has no integer solution. 
\end{result_box}

\subsection{Robustness of \texorpdfstring{$b_1 = 3$}{b1 = 3}}
...
\item A distinguished set of configurations respecting CP-symmetry: 8 balanced signed $K_4$
  graphs (PDL) and a CP-paired structure in 
$\Omega_{21}$ (e.g., the isolated vertex 21 forms a CP-pair with vertex 42 under $x \mapsto 63 - x$).
\end{itemize}
They differ in:
\begin{itemize}
...
\subsection{Frequency of \texorpdfstring{$\beta_1 = 3$}{b1 = 3} at scale 21}
...
Physical output & cosmological constant & gauge group $\mathrm{SU}(3)\times\mathrm{SU}(2)\times\mathrm{U}(1)$ \\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{Level 3 (speculative):} There exists a single mathematical object $X$ of which $K_4$ (PDL) and $\Omega_{21}$ (OFN) are two projections, and whose topological properties simultaneously determine the cosmological constant and the Standard Model gauge group. At this level, the two frameworks would be complementary descriptions of the same pre-geometric reality.
...
\midrule
Selection of $\Omega_{21}$ manifold & Structural postulate (anchored in Bachani 2026) & Sec.~3.1 \\
...
$b_1(\Omega_{21}) = 3$ under dist-1 adjacency & Verified result & Sec.~\ref{sec:ofn}, Scripts 3 \\
...
\item $b_1(\Omega_{21}) = 3$ under Hamming distance $= 1$ adjacency, independently verified. The isolated vertex 21 is not self-conjugate; $\Omega_{21}$ contains no self-conjugate states.
...
C.L.\ thanks Stam Nicolis and Mrutunjaya Bhuyan for critical comments on related questions posted on ResearchGate. 

% ─────────────────────────────────────────────────────────────────────────────
\bibliographystyle{unsrt}
\begin{thebibliography}{9}

\bibitem{Laubscher_DM_2026}
C. Laubscher, \emph{Projective Dynamic Logo (PDL) --- Global Mapping of
Structures, Results, and Open Problems (Version~23)}, Document DM v23 (2026).
\newblock DOI: \href{https://doi.org/10.5281/zenodo.20181077}{10.5281/zenodo.20181077}.

\bibitem{Laubscher_D53_2026}
C. Laubscher, \emph{From Four Axioms to the Cosmological Constant: Causal
Closure of the Chain C1--C4 to $\Lambda$ --- A Synthesis and Computational
Verification}, Document D53 (2026).
\newblock DOI: \href{https://doi.org/10.5281/zenodo.20052558}{10.5281/zenodo.20052558}.

\bibitem{Laubscher_D51_2026}
C. Laubscher, \emph{The Cosmological Leakage Constant from the PDL Axioms:
A Structural Derivation of $C$ and Resolution of OP1-D35}, Document D51 (2026).
\newblock DOI: \href{https://doi.org/10.5281/zenodo.20033520}{10.5281/zenodo.20033520}.

\bibitem{Laubscher_D52_2026}
C. Laubscher, \emph{Formal Identification of the Three Leakage Bases as Natural
Representatives of the Three Cycles of $\beta_1(K_4)=3$: Completion of the
Proof of Conjecture PDL-C}, Document D52 (2026).
\newblock DOI: \href{https://doi.org/10.5281/zenodo.20036769}{10.5281/zenodo.20036769}.

\bibitem{Evdokimov_OFN_2026}
O. I. Evdokimov, \emph{Article IV: Cosmology as Reading --- Emergent Spacetime,
Cartan Gravity, and Observational Signatures from the Static Ontological
Fundamental Network} (2026).
\newblock DOI: \href{https://doi.org/10.5281/zenodo.18642431}{10.5281/zenodo.18642431}.

\bibitem{Evdokimov_CWS_2026}
E. Ryss and O. I. Evdokimov, \emph{OFN as a CWS Quantum Code on the Octahedron
Graph and its Cosmological and Philosophical Consequences} (2026).
\newblock DOI: \href{https://doi.org/10.5281/zenodo.20322830}{10.5281/zenodo.20322830}.

\bibitem{Laubscher_D36_2026}
C. Laubscher, \emph{Proof of $G_{\mathrm{eff}}(N) = \sigma(N) \cdot G_{\mathrm{PDL}}$
from the Trace Structure of $K_4$ and Independence of Gravitational Engagement},
Document D36 (2026).
\newblock DOI: \href{https://doi.org/10.5281/zenodo.19323033}{10.5281/zenodo.19323033}.

\bibitem{Bachani2026}
S. H. Bachani, \emph{S21 Theory: Complete First-Principles Derivation} (2026).
\newblock DOI: \href{https://doi.org/10.2139/ssrn.6180841}{10.2139/ssrn.6180841}.
