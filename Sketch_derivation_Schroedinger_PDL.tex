...
\item The combinatorial specification of the proton, characterised by a valence content $r_{\mathrm{val}}=930$ and a relational sea of cardinality $R_{\mathrm{sea}}=10\,087$, together with the definition of an active surface $S_{\mathrm{act}}$ of size $R_{\mathrm{surf}}=\varphi r_{\mathrm{val}}/3$. The latter represents the finite subset of protonic relations that can couple coherently to an external $(4,6)$ block.\cite{Laubscher2026PDL_English,Laubscher2026LDP_French,Laubscher2026DerivationAlpha}
\item The structural formula for the fine-structure constant,
\begin{equation}
\alpha_{\mathrm{PDL}}^{-1} = \mu\,\varphi^{2}\,\frac{r_{\mathrm{val}}^{2}}{9},
\end{equation}
which links $\alpha$ to the proton–electron mass ratio $\mu$, the valence content $r_{\mathrm{val}}$, and the optimisation factor $\varphi$, and reproduces the empirical value of $\alpha$ to within a few parts in $10^{-4}$.\cite{Laubscher2026DerivationAlpha}
